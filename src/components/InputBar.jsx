    ...
    return (
        <div className="px-3 md:px-6 py-4 md:py-8 bg-transparent relative">
            <div className="max-w-3xl mx-auto relative">
                ...
                <div className="flex items-center gap-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-[2rem] px-4 py-2 shadow-sm transition-all focus-within:border-slate-400 dark:focus-within:border-white/20 group">
                    <input 
                        type="file" 
                        ref={fileInputRef} 
                    ...
                    <div className="flex items-center gap-1 self-center">
                        ...
                        <button className="w-8 h-8 rounded-full hover:bg-slate-100 dark:hover:bg-white/5 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
