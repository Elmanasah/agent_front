...
export default function HistorySidebar({ history, currentSessionId, onSelectSession, onNewChat, isOpen, onToggle, theme, onToggleTheme }) {
    ...
    if (!isOpen) {
        return (
            <div className="flex flex-col h-full w-16 bg-white dark:bg-slate-950 border-r border-slate-200 dark:border-white/10 items-center py-4 gap-4 transition-all overflow-hidden shrink-0">
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-white/10 animate-fade-in w-[260px] shrink-0 z-50 transition-all">
            {/* Top Icons */}
